    ...
    public void PerformHarvest(int a)
    {
        if (harvestList.Count < 20)
        {
            ...
            else if (a == 2)
            {
                ...
                newHarvest2.transform.parent = transform; // Harvest objesinin altýnda kalmasýný saðla
            ...
            else if (a == 3)
            {
                ...
                newHarvest3.transform.parent = transform; // Harvest objesinin altýnda kalmasýný saðla
